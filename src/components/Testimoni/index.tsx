...
const Testimoni: React.FC = () => {
  return (
    <section>
      <div className="py-32">
        <h1 className="font-semibold text-deep-cove-900 font-clash text-center text-[80px] leading-[85px] justify-center flex px-64">
          Kata mereka tentang Dusun Krecek
        </h1>

        <div className="relative z-10 flex flex-col md:flex-row md:gap-10 px-24 pt-12 mb-[-130px]">
        ...
        <div className="relative -mt-10 pt-40 z-0 flex justify-center gap-20 px-24 pb-28 bg-gradient-to-l from-lime-500 to-lime-900 items-center separator">
          <div className="text-white w-1/2">
            <h1 className="pb-2 font-semibold font-clash md:text-[80px] leading-[80px]">
              Tertarik ke Dusun Krecek?
            </h1>
            <p className="text-xs sm:text-xl mt-3 font-dm tracking-wide">
