    ...
    <div className="flex flex-col md:flex-row font-dm bg-white">
      <div className="flex flex-col md:flex-row justify-center my-12 w-full gap-8 xl:gap-64 px-4">
        <div className="flex mb-8 justify-center">
          <Image src="/images/logo.png" width={270} height={110} alt="logo" />
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2 text-[#8D804F]">
              <li className="flex items-center space-x-2">
                <a
                  href="https://www.instagram.com/seputar_krecek"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-2"
                >
              ...
              <li className="flex items-center space-x-2">
                <a
                  href="https://www.instagram.com/buddhazine"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-2"
                >
              ...
              <li className="flex items-center space-x-2">
                <a
                  href="https://www.instagram.com/desabinaan.kmbui"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-2"
                >
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2 text-[#8D804F]">
              <li className="flex items-center space-x-2">
                <a
                  href="https://www.youtube.com/@kampungbudayakrecek1858"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-2"
                >
